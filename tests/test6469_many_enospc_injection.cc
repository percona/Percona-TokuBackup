...
bool disable_injections = true;
std::vector<long> injection_pattern; // On the Kth pwrite or write, return ENOSPC, if K is in this vector.
std::vector<int>  ignore_fds;        // Don't count pwrite or write to any fd in this vector.
long injection_write_count = 0;
