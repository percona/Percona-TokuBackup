...
#ident "$Id: unlink.cc 54729 2013-03-26 16:24:56Z bkuszmaul $"
...
static int verify(void)
{
    ...
    // Verify the first N - 1 were unlinked.
    for (int i = 0; i < N - 1; ++i) {
    ...
    if (stat_r != 0) {
        result = -1;
        printf("destination file : %s should exist, but its missing or inaccessible.\n", destination_file);
    }
