...
public:
    ...
    int put(int fd, file_description**result) __attribute__((warn_unused_result)); // create a file description, put it in the map, and return it.  If things go bad, inform the backup manager and return the error code.
