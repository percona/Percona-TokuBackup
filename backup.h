...
const extern char tokubackup_version[]  __attribute__((visibility("default"))); // Put an "e" on the end of the mysql version if we are running with the backup library.
